...
<!--20240503_ym  에디터에서 수정하면 데이터가 직접 들어오는 장소 시작-->
	<form action="insertNotice.ko" method="post" id="dataTransferForm" enctype="multipart/form-data">
			<div style="padding-left: 10px;">
				<input type="text" name="not_title" required style="width: 80%; height: 30px; margin: 0 auto; display: inline-block; padding-left: 10;">
				<input type="button" onclick="submitContents();" value="새 글 등록" style="float: right; margin: 0 10px;">
				<button id="conList" type="button" style="float: right;">글목록</button>
			</div>
			<div>
      <textarea name="not_content" id="ir1" rows="10" cols="100" style="width:766px; height:412px; display:none;"></textarea>      
			</div>
			<div>
