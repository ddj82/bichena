...
<div class="container">
	...
	<c:choose>
	    ...
	    <c:otherwise>
	        <!-- 이전 페이지로 이동하는 링크 -->
	        <a href="getFaqList.ko?currPageNo=${pagination.currPageNo - 1}&searchKeyword=${keyword}&searchCondition=${condition}" class="btn btn-primary btn-sm">이전</a>
	    </c:otherwise>
	</c:choose>
	...
	<c:choose>
	    ...
	    <c:otherwise>
	        <!-- 다음 페이지로 이동하는 링크 -->
	        <a href="getFaqList.ko?currPageNo=${pagination.currPageNo + 1}&searchKeyword=${keyword}&searchCondition=${condition}" class="btn btn-primary btn-sm">다음</a>
		</c:otherwise>
	</c:choose>
	<br>
	<br>
